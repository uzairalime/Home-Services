                    ...
                    child: GetBuilder<StartEarningController>(
                        builder: (_) =>
                            Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                              ...
                              title(context, LocaleKeys.start_earning_item_enter_select_catg.tr),
                              SizedBox(
                                ...
                                child: DropdownButtonFormField(
                                  ...
                                  hint: Text(LocaleKeys.start_earning_item_enter_select_catg.tr),
                                  ...
                                  child: Row(children: [
                                    Expanded(
                                      ...
                                      child: DropdownButtonFormField(
                                        ...
                                        menuMaxHeight: mediaQueryHeight(context) * 0.4,
                                        hint:
                                            Text(LocaleKeys.start_earning_item_enter_from_hours.tr),
                                    ...
                                    Expanded(
                                      ...
                                      child: DropdownButtonFormField(
                                        ...
                                        menuMaxHeight: mediaQueryHeight(context) * 0.4,
                                        hint:
                                            Text(LocaleKeys.start_earning_item_enter_till_hours.tr),
                                        items: controller.hours
                                            .map<DropdownMenuItem<String>>((String value) {
                                          return DropdownMenuItem<String>(
                                            value: value,
...
// class StartEarning extends GetView<StartEarningController> {
//   const StartEarning({Key? key}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     BookingController con = Get.put(BookingController());
