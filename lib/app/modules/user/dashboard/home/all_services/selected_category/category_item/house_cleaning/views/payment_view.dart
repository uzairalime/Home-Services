          ...
          child: Column(
            ...
            children: [
              const CText(
                  ...
                  text: 'Please select a payment refund method'),
...
class PaymentModel {
  ...
  static List<PaymentModel> list = [
    PaymentModel(
        "Stripe", "Special promo only today!", "assets/icons/stripeicon.svg"),
    PaymentModel(
        "Paypal", "Special promo only today!", "assets/icons/ic_paypal.svg"),
    PaymentModel(
        "Google pay", "Special promo only today!", "assets/icons/ic_gmail.svg"),
    PaymentModel("Apple Pay", "Special promo only Valid today",
        "assets/icons/apple_ic.svg"),
    PaymentModel("Master card", "Special promo only today!",
        "assets/icons/ic_mastercard.svg"),
    PaymentModel("Cash Money", "Special promo only today!",
