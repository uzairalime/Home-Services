...
import '../../../../../views/location_pick.dart';
...
class BookingController extends GetxController {
  ...
  postBooking(PostBookingModel model, context) async {
    ...
    // await _apiHelper
    //     .httppost("user/booking/", model.toJson())
    //     .then((response) async {
    //   final id = response["id"];
    //   logger.d("id  is ====== $id");
    //
    //   String amount = response["price"];
    //   logger.d("payment is =========== $amount");
    //   if (id != null) {
    //     await _apiHelper.httppost("user/booking/$id/payment-sheet/", {}).then(
    //         (response) async {
    //       String paymentIntent = response["payment_intent"];
    //       logger
    //           .d("pyament intet is============= ${response["payment_intent"]}");
    //
    //       DialogHelper.hideLoading();
    //       Get.offNamed(Routes.DASHBOARD);
    //       HomeController.to.startLoop();
