...
import '../../../../seller/dashboard/jobs/controllers/jobs_controller.dart';
import '../controllers/my_bookings_controller.dart';

class CompletedBookings extends GetView<MyBookingController> {
    ...
    return GetBuilder(
        ...
        builder: (context) {
          return FutureBuilder(
            future: controller
                .fetchCompletedBookings(), // Call your fetch data function
