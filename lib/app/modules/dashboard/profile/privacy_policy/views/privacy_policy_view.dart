...
import 'package:home_brigadier/app/modules/dashboard/profile/privacy_policy/controllers/privacy_policy_controller.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 13, right: 13, top: 5, bottom: 13),
            child: Text(
